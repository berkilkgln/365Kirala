...
import ReservationBox from '../../../components/ReservationBox'; // varsa ekle
...
export default function BungalovDetailPage() {
  ...
  useEffect(() => {
    if (!id) return;
    const found = bungalovData.items.find((item) => item.id === id);
    setBungalov(found || null);
  }, [id]);
      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-16">
          ...
          <nav className="text-sm text-gray-500 mb-6 flex items-center space-x-2">
            ...
            <span>/</span>
            <Link href="/bungalov" className="hover:text-indigo-600">Bungalovlar</Link>
            <span>/</span>
            ...
            <div className="md:col-span-2">
              ...
              <div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {bungalov.features.map((feature, idx) => (
                    <li
                      key={idx}
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded-3xl bg-gradient-to-b from-white via-white/90 to-white/80 backdrop-blur-lg p-6 shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-gray-100">
                ...
                <p className="text-center text-xs text-gray-500 mt-4 leading-snug">
                  Rezervasyonlar <strong>7/24</strong> alınmaktadır. <br />
