    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 font-semibold">
        <SinglePageHeader
          ...
          descriptionDesktop="İstanbul, Bodrum, Göcek, Fethiye, Marmaris ve Antalya'da özel bungalov kiralama ile doğayla iç içe bir tatil yaşayın. Günlük ve haftalık seçeneklerle, özel hizmetlerle tatilin keyfini çıkarın."
          descriptionMobile="İstanbul, Bodrum, Göcek, Fethiye, Marmaris ve Antalya'da özel bungalov kiralama ile doğayla iç içe bir tatil yapın."
        />
