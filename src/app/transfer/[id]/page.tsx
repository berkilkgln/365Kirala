      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="relative w-full h-72 overflow-hidden bg-gradient-to-r from-indigo-900 to-blue-800">
          ...
          <div className="relative z-20 flex flex-col items-center justify-center h-full text-white text-center px-4">
            ...
            <p className="text-2xl md:text-3xl drop-shadow-lg">{transfer.location}</p>
          </div>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="md:col-span-2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">{transfer.title}</h2>
              <p className="text-lg text-gray-700 mb-10 leading-relaxed">{transfer.description}</p>

              {/* Özellikler */}
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">Transfer Özellikleri</h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {transfer.features.map((feature: string, index: number) => (
                    <li
                      key={index}
