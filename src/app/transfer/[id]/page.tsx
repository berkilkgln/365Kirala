      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <nav className="text-sm text-gray-500 mb-4 md:mb-6 flex items-center space-x-2">
            ...
            <span>/</span>
            <Link href="/transfer" className="hover:text-indigo-600">Transfer Hizmetleri</Link>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10">
            ...
            <div className="lg:col-span-2">
              ...
              <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4">Özellikler</h3>
