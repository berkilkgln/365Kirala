    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 font-semibold">
        <SinglePageHeader
          ...
          descriptionDesktop="İstanbul, Ankara, Antalya ve diğer büyük şehirlerde VIP transfer hizmeti. Lüks araçlar, profesyonel şoförler ve 7/24 güvenli, konforlu ulaşım. Havalimanı, otel, iş toplantısı ve özel etkinlikler için prestijli çözümler."
          descriptionMobile="İstanbul, Ankara, Antalya ve büyük şehirlerde VIP transfer hizmeti. Lüks araçlarla güvenli ve konforlu ulaşım."
        />

        <h1 className="text-3xl font-bold mb-6 mt-5 text-center md:text-left">Transfer Hizmetleri</h1>
