    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 font-semibold">
        <SinglePageHeader
          ...
          title="Günlük Turlar"
          descriptionDesktop="İstanbul, Kapadokya, Antalya ve Türkiye’nin eşsiz bölgelerinde rehberli günlük turlar! Uygun fiyatlı, konforlu ve kültürel gezi fırsatlarıyla unutulmaz anlar yaşayın. Hemen rezervasyon yapın."
          descriptionMobile="İstanbul, Kapadokya, Antalya ve Türkiye’nin eşsiz bölgelerinde rehberli günlük turlar! Hemen rezervasyon yapın."
        />
