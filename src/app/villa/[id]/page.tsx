      ...
      <div className="bg-gradient-to-br from-gray-50 to-white min-h-screen">
              ...
              <div className="max-w-screen-xl mx-auto">
                ...
                <div className="flex items-center gap-6 text-white">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-base">Premium Villa</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <nav className="text-sm text-gray-500 mb-8 flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 w-fit">
            ...
            <Link href="/villa" className="hover:text-indigo-600 transition-colors">Villalar</Link>
            <span className="text-gray-300">/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Villa Bilgileri - Enhanced */}
              <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-8 rounded-2xl border border-emerald-100 shadow-sm">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">Villa Bilgileri</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white rounded-xl p-4 shadow-sm border">
                    <div className="text-sm text-gray-500 mb-1">Lokasyon</div>
                    <div className="font-bold text-gray-900">{villa.location}</div>
                  </div>
                  <div className="bg-white rounded-xl p-4 shadow-sm border">
                    <div className="text-sm text-gray-500 mb-1">Rezervasyon</div>
                    <div className="font-bold text-emerald-600">{villa.booked}+ kişi tercih etti</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">Villa Detayları</h2>
                </div>
                <p className="text-gray-700 leading-relaxed text-lg">{villa.description}</p>
              </div>

              {/* Villa Özellikleri - Enhanced */}
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">Villa Özellikleri</h2>
                </div>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded-3xl bg-gradient-to-br from-white via-white/95 to-white/90 backdrop-blur-lg p-8 shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-gray-100">
                ...
                <div className="flex justify-center items-end gap-2 mb-4">
                  ...
                  <span className="text-lg text-gray-500 mb-2">/ gece</span>
                </div>
              ...
              <div className="rounded-3xl bg-gradient-to-br from-white via-white/95 to-white/90 backdrop-blur-lg p-8 shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-gray-100">
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                  <p className="text-center text-sm text-gray-700 leading-relaxed">
                    <span className="font-bold text-blue-600">7/24</span> villa kiralama rezervasyonları <br />
