    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 font-semibold">
        <SinglePageHeader
          ...
          descriptionDesktop="Fethiye, Kaş, Kalkan, Antalya ve Sapanca’da özel havuzlu günlük ve haftalık villalarla lüks bir tatil yaşayın. Balayı, aile veya arkadaş grupları için doğa ve deniz manzaralı villa kiralama fırsatlarını keşfedin."
          descriptionMobile="Fethiye, Kaş, Kalkan, Antalya ve Sapanca’da günlük ve haftalık villa kiralama fırsatlarını keşfedin."
        />
