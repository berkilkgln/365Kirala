    ...
    <>
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-8 font-semibold">
        <SinglePageHeader
          ...
          title="Lüks Villa Kiralama"
          descriptionDesktop="Bodrum, Fethiye, Kalkan ve Kaş'ta özel havuzlu, deniz manzaralı lüks villalar. Konforlu ve güvenli bir tatil için tüm detaylar düşünüldü."
          descriptionMobile="Özel havuzlu ve deniz manzaralı lüks villalarda unutulmaz bir tatil deneyimi."
        />

        <div className="mt-8">
          <h1 className="text-3xl font-bold mb-6 text-center md:text-left">Lüks Villa Kiralama</h1>
